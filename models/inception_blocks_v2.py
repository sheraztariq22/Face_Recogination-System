"""
Inception Blocks for FaceNet Model
models/inception_blocks_v2.py
"""
...
from tensorflow.keras.layers import (
    ...
    AveragePooling2D, Lambda, Flatten, Dense
)
...
def conv2d_bn(x,
              ...
              padding=None):
    """
    Utility function to apply conv + BN (copied from fr_utils to avoid circular import)
...
def inception_block_1a(X):
    """
    Implementation of inception block 1a
    
    Args:
        X: Input tensor
        
    Returns:
        Concatenated tensor from all paths
    """
...
def inception_block_1b(X):
    """Implementation of inception block 1b"""
...
def inception_block_1c(X):
    """Implementation of inception block 1c"""
    X_3x3 = conv2d_bn(X,
...
def inception_block_2a(X):
    """Implementation of inception block 2a"""
    X_3x3 = conv2d_bn(X,
...
def inception_block_2b(X):
    """Implementation of inception block 2b (inception4e)"""
    X_3x3 = conv2d_bn(X,
...
def inception_block_3a(X):
    """Implementation of inception block 3a"""
    X_3x3 = conv2d_bn(X,
...
def inception_block_3b(X):
    """Implementation of inception block 3b"""
    X_3x3 = conv2d_bn(X,
...
def faceRecoModel(input_shape):
    ...
    # Inception blocks 1: a/b/c
    X = inception_block_1a(X)
    X = inception_block_1b(X)
    X = inception_block_1c(X)
    
    # Inception blocks 2: a/b
    X = inception_block_2a(X)
    X = inception_block_2b(X)
    
    # Inception blocks 3: a/b
